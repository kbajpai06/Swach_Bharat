export default function Footer(){
    return (
      <div>
         <footer className="bg-[#0b0e37] text-white py-8 px-4 font-sans tracking-wide">
      <div className="text-center">
        <h5 className="text-base">Stay connected with us:</h5>

        <ul className="flex flex-wrap justify-center gap-x-8 gap-4 my-8">
          <li><a href="https://www.facebook.com/share/vFPd22ZM1n4rosxy/?mibextid=LQQJ4d" className="text-xl hover:text-gray-400">
          ...
          <li><a href="http://www.linkedin.com/in/sudhaar-app-90045a331" className="text-xl hover:text-gray-400">
          ...
          <li><a href="https://www.instagram.com/_sudhaar?igsh=a2Fqb290Nnhyd3l3" className="text-xl hover:text-gray-400">
          ...
          <li><a href="https://x.com/_Sudhaar" className="text-xl hover:text-gray-400">
